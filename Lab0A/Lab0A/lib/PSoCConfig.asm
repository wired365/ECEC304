...
export LoadConfig_lab0a
export _LoadConfig_lab0a
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab0a
	lcall	LoadConfigTBL_lab0a_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab0a
;
;    Load configuration registers for lab0a.
...
_LoadConfig_lab0a:
 LoadConfig_lab0a:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab0a_Bank0
    mov     X, <LoadConfigTBL_lab0a_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab0a_Bank1
    mov     X, <LoadConfigTBL_lab0a_Bank1
