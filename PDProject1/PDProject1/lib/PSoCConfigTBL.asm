...
;       Instance name VR_ADC, Block Name ADC(ASC10)
	...
	db		81h, 00h		;VR_ADC_AtoDcr1(ASC10CR1)
	db		82h, 60h		;VR_ADC_AtoDcr2(ASC10CR2)
	db		83h, f0h		;VR_ADC_AtoDcr3(ASC10CR3)
;       Instance name VR_ADC, Block Name PWM(DBB00)
	db		23h, 00h		;VR_ADC_PWMcr0(DBB00CR0)
	db		21h, 00h		;VR_ADC_PWMdr1(DBB00DR1)
	db		22h, 01h		;VR_ADC_PWMdr2(DBB00DR2)
;  Instance name VR_PGA, User Module PGA
;       Instance name VR_PGA, Block Name GAIN(ACB00)
	db		71h, fdh		;VR_PGA_GAIN_CR0(ACB00CR0)
	db		72h, 21h		;VR_PGA_GAIN_CR1(ACB00CR1)
	db		73h, 20h		;VR_PGA_GAIN_CR2(ACB00CR2)
	db		70h, 00h		;VR_PGA_GAIN_CR3(ACB00CR3)
...
;       Instance name VR_ADC, Block Name ADC(ASC10)
;       Instance name VR_ADC, Block Name PWM(DBB00)
	db		20h, 31h		;VR_ADC_PWMfn(DBB00FN)
	db		21h, 15h		;VR_ADC_PWMsl(DBB00IN)
	db		22h, 40h		;VR_ADC_PWMos(DBB00OU)
;  Instance name VR_PGA, User Module PGA
;       Instance name VR_PGA, Block Name GAIN(ACB00)
