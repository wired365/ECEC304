...
export LoadConfig_pdproject1
export _LoadConfig_pdproject1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_pdproject1
	lcall	LoadConfigTBL_pdproject1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration pdproject1
;
;    Load configuration registers for pdproject1.
...
;               CUR_PP
;
_LoadConfig_pdproject1:
 LoadConfig_pdproject1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pdproject1_Bank0
    mov     X, <LoadConfigTBL_pdproject1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pdproject1_Bank1
